...
#define ZEPHIR_CONCAT_VSVSVSVSV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_vsvsvsvsv(&result, op1, op2, sizeof(op2)-1, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_VSVSVSVSV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9) \
	 zephir_concat_vsvsvsvsv(&result, op1, op2, sizeof(op2)-1, op3, op4, sizeof(op4)-1, op5, op6, sizeof(op6)-1, op7, op8, sizeof(op8)-1, op9, 1 TSRMLS_CC);
...
void zephir_concat_vsvsvsvsv(zval **result, zval *op1, const char *op2, zend_uint op2_len, zval *op3, const char *op4, zend_uint op4_len, zval *op5, const char *op6, zend_uint op6_len, zval *op7, const char *op8, zend_uint op8_len, zval *op9, int self_var TSRMLS_DC);
