...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_model_entity, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, newRow, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_model_aggregation, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_model_groupaggregations, 0, 0, 2)
...
ZEPHIR_INIT_FUNCS(nc_db_model_method_entry) {
	...
	PHP_ME(Nc_Db_Model, groupAggregations, arginfo_nc_db_model_groupaggregations, ZEND_ACC_PUBLIC)
