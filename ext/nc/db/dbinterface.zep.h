...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_queryandfetch, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_queryall, 0, 0, 1)
	ZEND_ARG_INFO(0, sql)
	ZEND_ARG_ARRAY_INFO(0, params, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_querycolumns, 0, 0, 1)
	ZEND_ARG_INFO(0, sql)
	ZEND_ARG_ARRAY_INFO(0, params, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_selectrow, 0, 0, 1)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, options, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_selectcell, 0, 0, 1)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, options, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_dbinterface_selectcolumns, 0, 0, 1)
	ZEND_ARG_INFO(0, table)
	ZEND_ARG_ARRAY_INFO(0, options, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(nc_db_dbinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, queryAndFetch, arginfo_nc_db_dbinterface_queryandfetch)
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, query, arginfo_nc_db_dbinterface_query)
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, queryAll, arginfo_nc_db_dbinterface_queryall)
	...
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, queryColumns, arginfo_nc_db_dbinterface_querycolumns)
	...
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, selectRow, arginfo_nc_db_dbinterface_selectrow)
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, selectCell, arginfo_nc_db_dbinterface_selectcell)
	PHP_ABSTRACT_ME(Nc_Db_DbInterface, selectColumns, arginfo_nc_db_dbinterface_selectcolumns)
