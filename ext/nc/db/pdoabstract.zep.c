...
PHP_METHOD(Nc_Db_PdoAbstract, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, 19, _3);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "func_get_args", NULL, 13);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, _2, "newinstanceargs", NULL, 20, _5);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Db_PdoAbstract, queryAndFetch) {
	...
	ZEPHIR_CALL_CE_STATIC(&_12, nc_db_dbabstract_ce, "profiledquery", &_13, 21, sql, params, _14);
	zephir_check_call_status();
