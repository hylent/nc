...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_oci8_query, 0, 0, 1)
	ZEND_ARG_INFO(0, sql)
	ZEND_ARG_ARRAY_INFO(0, params, 1)
	ZEND_ARG_INFO(0, mode)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_db_oci8_paginationsql, 0, 0, 3)
...
ZEPHIR_INIT_FUNCS(nc_db_oci8_method_entry) {
	...
	PHP_ME(Nc_Db_Oci8, query, arginfo_nc_db_oci8_query, ZEND_ACC_PUBLIC)
	PHP_ME(Nc_Db_Oci8, paginationSql, arginfo_nc_db_oci8_paginationsql, ZEND_ACC_PUBLIC)
	PHP_ME(Nc_Db_Oci8, randomOrderSql, NULL, ZEND_ACC_PUBLIC)
