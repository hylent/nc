...
PHP_METHOD(Nc_Db_DbAbstract, rollback) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("inTransaction"), PH_NOISY_CC);
	if (unlikely(!zephir_is_true(_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_transactionexception_ce, "Cannot rollback when not in transaction", "nc/db/dbabstract.zep", 94);
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "trytorollback", NULL, 0);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_1))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_transactionexception_ce, "Cannot rollback transaction", "nc/db/dbabstract.zep", 98);
		return;
	}
	if (0) {
		zephir_update_property_this(this_ptr, SL("inTransaction"), ZEPHIR_GLOBAL(global_true) TSRMLS_CC);
...
PHP_METHOD(Nc_Db_DbAbstract, savepoint) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("inTransaction"), PH_NOISY_CC);
	if (unlikely(!zephir_is_true(_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_transactionexception_ce, "Cannot acquire a savepoint when not in a transaction", "nc/db/dbabstract.zep", 108);
		return;
	}
	...
	if (unlikely(zephir_array_isset(_1, savepoint))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$4, "nc/db/dbabstract.zep", 112 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_4);
...
PHP_METHOD(Nc_Db_DbAbstract, releaseSavepoint) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("inTransaction"), PH_NOISY_CC);
	if (unlikely(!zephir_is_true(_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_transactionexception_ce, "Cannot release a savepoint when not in a transaction", "nc/db/dbabstract.zep", 122);
		return;
	}
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("savepoints"), PH_NOISY_CC);
	if (unlikely(!(zephir_array_isset(_1, savepoint)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, _2$$4, "__construct", NULL, 2, _3$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$4, "nc/db/dbabstract.zep", 126 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_4);
...
PHP_METHOD(Nc_Db_DbAbstract, rollbackToSavepoint) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("inTransaction"), PH_NOISY_CC);
	if (unlikely(!zephir_is_true(_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_transactionexception_ce, "Cannot rollback to a savepoint when not in a transaction", "nc/db/dbabstract.zep", 136);
		return;
	}
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("savepoints"), PH_NOISY_CC);
	if (unlikely(!(zephir_array_isset(_1, savepoint)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, _2$$4, "__construct", NULL, 2, _3$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$4, "nc/db/dbabstract.zep", 140 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_4);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$5, "array_pop", &_7, 3, _5$$5);
		ZEPHIR_UNREF(_5$$5);
		zephir_check_call_status();
...
PHP_METHOD(Nc_Db_DbAbstract, insert) {
	...
	array_init(vs);
	ZEPHIR_INIT_VAR(_0);
	zephir_is_iterable(data, &_2, &_1, 0, 0, "nc/db/dbabstract.zep", 178);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		zephir_array_append(&ks, k, PH_SEPARATE, "nc/db/dbabstract.zep", 174);
		ZEPHIR_INIT_LNVAR(_4$$3);
		ZEPHIR_CONCAT_SV(_4$$3, ":", k);
		zephir_array_append(&vs, _4$$3, PH_SEPARATE, "nc/db/dbabstract.zep", 175);
	}
	ZEPHIR_INIT_VAR(_5);
...
PHP_METHOD(Nc_Db_DbAbstract, update) {
	...
	array_init(kvs);
	ZEPHIR_INIT_VAR(_0);
	zephir_is_iterable(data, &_2, &_1, 0, 0, "nc/db/dbabstract.zep", 197);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
...
PHP_METHOD(Nc_Db_DbAbstract, upsert) {
	...
	zend_bool inTransaction = 0;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *data = NULL;
	zval *table_param = NULL, *data_param = NULL, *primaryKey = NULL, *where = NULL, *ex = NULL, *_0, *_1$$4 = NULL, *_2$$4;
	zval *table = NULL, *savepoint = NULL, *_3$$4 = NULL;
	...
	if (unlikely(zephir_fast_count_int(where TSRMLS_CC) < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Cannot upsert with empty where", "nc/db/dbabstract.zep", 218);
		return;
	}
	ZEPHIR_OBS_VAR(_0);
	zephir_read_property_this(&_0, this_ptr, SL("inTransaction"), PH_NOISY_CC);
	inTransaction = zephir_get_boolval(_0);
	if (inTransaction) {
		ZEPHIR_INIT_VAR(_2$$4);
		ZVAL_STRING(_2$$4, "upsert", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "nextflag", NULL, 0, _2$$4);
		zephir_check_temp_parameter(_2$$4);
		zephir_check_call_status();
		zephir_get_strval(_3$$4, _1$$4);
		ZEPHIR_CPY_WRT(savepoint, _3$$4);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "savepoint", NULL, 0, savepoint);
		zephir_check_call_status();
	} else {
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(ex, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
			...
			zephir_throw_exception_debug(ex, "nc/db/dbabstract.zep", 238 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
	if (inTransaction) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "releasesavepoint", NULL, 0, savepoint);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Nc_Db_DbAbstract, parseSelect) {
	...
	ZEPHIR_CALL_CE_STATIC(&_5, nc_std_ce, "valueat", &_1, 4, options, _3, _2);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(_8);
	ZVAL_BOOL(_8, 1);
	ZEPHIR_CALL_CE_STATIC(&orderBy, nc_std_ce, "valueat", &_1, 4, options, _3, _7, _8);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_3);
	...
	ZEPHIR_INIT_NVAR(_7);
	ZVAL_LONG(_7, 0);
	ZEPHIR_CALL_CE_STATIC(&_9, nc_std_ce, "valueat", &_1, 4, options, _3, _7);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_7);
	ZVAL_LONG(_7, 0);
	ZEPHIR_CALL_CE_STATIC(&_10, nc_std_ce, "valueat", &_1, 4, options, _3, _7);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_7);
	ZVAL_BOOL(_7, 0);
	ZEPHIR_CALL_CE_STATIC(&_11, nc_std_ce, "valueat", &_1, 4, options, _3, _7);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Db_DbAbstract, countAndSelect) {
	...
	ZEPHIR_INIT_VAR(_3);
	ZVAL_STRING(_3, "where", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_CE_STATIC(&_0, nc_std_ce, "valueat", &_1, 4, options, _3, _2);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Db_DbAbstract, selectUnionAll) {
	...
	zephir_is_iterable(selects, &_1, &_0, 0, 0, "nc/db/dbabstract.zep", 360);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		zephir_array_append(&a, _6$$4, PH_SEPARATE, "nc/db/dbabstract.zep", 357);
	}
	ZEPHIR_INIT_VAR(_7);
	...
	ZEPHIR_INIT_VAR(_14);
	ZVAL_BOOL(_14, 1);
	ZEPHIR_CALL_CE_STATIC(&orderBy, nc_std_ce, "valueat", &_12, 4, options, _10, _13, _14);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_10);
	...
	ZVAL_LONG(_13, 0);
	ZEPHIR_CALL_CE_STATIC(&_15, nc_std_ce, "valueat", &_12, 4, options, _10, _13);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_13);
	ZVAL_LONG(_13, 0);
	ZEPHIR_CALL_CE_STATIC(&_16, nc_std_ce, "valueat", &_12, 4, options, _10, _13);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Db_DbAbstract, countAndSelectUnionAll) {
	...
	zephir_is_iterable(selects, &_2, &_1, 0, 0, "nc/db/dbabstract.zep", 398);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		...
		zephir_array_append(&a, _7$$4, PH_SEPARATE, "nc/db/dbabstract.zep", 395);
	}
	ZEPHIR_INIT_VAR(_8);
...
PHP_METHOD(Nc_Db_DbAbstract, aggregations) {
	...
	ZEPHIR_INIT_VAR(a);
	array_init(a);
	zephir_is_iterable(aggregations, &_1, &_0, 0, 0, "nc/db/dbabstract.zep", 461);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
		...
		zephir_array_append(&a, _3$$3, PH_SEPARATE, "nc/db/dbabstract.zep", 458);
	}
	ZEPHIR_INIT_VAR(_4);
...
PHP_METHOD(Nc_Db_DbAbstract, groupAggregations) {
	...
	ZEPHIR_CALL_CE_STATIC(&_5, nc_std_ce, "valueat", &_1, 4, options, _6, _3);
	...
	ZEPHIR_INIT_VAR(_9);
	ZVAL_BOOL(_9, 1);
	ZEPHIR_CALL_CE_STATIC(&orderBy, nc_std_ce, "valueat", &_1, 4, options, _6, _8, _9);
	zephir_check_temp_parameter(_6);
	zephir_check_call_status();
	zephir_array_append(&a, groupBy, PH_SEPARATE, "nc/db/dbabstract.zep", 484);
	zephir_is_iterable(aggregations, &_11, &_10, 0, 0, "nc/db/dbabstract.zep", 490);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_11, &_10)
		...
		zephir_array_append(&a, _13$$3, PH_SEPARATE, "nc/db/dbabstract.zep", 487);
	}
	ZEPHIR_INIT_NVAR(_6);
...
PHP_METHOD(Nc_Db_DbAbstract, parseWhere) {
	...
	ZEPHIR_INIT_VAR(ws);
	array_init(ws);
	zephir_is_iterable(where, &_1, &_0, 0, 0, "nc/db/dbabstract.zep", 629);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
		...
		ZEPHIR_MAKE_REF(ks);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "array_shift", &_4, 5, ks);
		ZEPHIR_UNREF(ks);
		zephir_check_call_status();
		zephir_get_strval(_5$$3, _3$$3);
		ZEPHIR_CPY_WRT(k1, _5$$3);
		ZEPHIR_MAKE_REF(ks);
		ZEPHIR_CALL_FUNCTION(&_6$$3, "array_shift", &_4, 5, ks);
		ZEPHIR_UNREF(ks);
		zephir_check_call_status();
		...
		do {
			if (ZEPHIR_IS_STRING(k2, "")) {
				if (Z_TYPE_P(v) == IS_NULL) {
					...
					zephir_array_append(&ws, _8$$5, PH_SEPARATE, "nc/db/dbabstract.zep", 533);
				} else {
					ZEPHIR_CALL_METHOD(&_9$$6, this_ptr, "quote", &_10, 0, v);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_11$$6);
					ZEPHIR_CONCAT_VSV(_11$$6, k1, " = ", _9$$6);
					zephir_array_append(&ws, _11$$6, PH_SEPARATE, "nc/db/dbabstract.zep", 535);
				}
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "neq")) {
				if (Z_TYPE_P(v) == IS_NULL) {
					...
					zephir_array_append(&ws, _12$$8, PH_SEPARATE, "nc/db/dbabstract.zep", 540);
				} else {
					ZEPHIR_CALL_METHOD(&_13$$9, this_ptr, "quote", &_14, 0, v);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_15$$9);
					ZEPHIR_CONCAT_VSV(_15$$9, k1, " <> ", _13$$9);
					zephir_array_append(&ws, _15$$9, PH_SEPARATE, "nc/db/dbabstract.zep", 542);
				}
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "lt")) {
				...
				zephir_array_append(&ws, _18$$10, PH_SEPARATE, "nc/db/dbabstract.zep", 546);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "lte")) {
				...
				zephir_array_append(&ws, _21$$11, PH_SEPARATE, "nc/db/dbabstract.zep", 549);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "gt")) {
				...
				zephir_array_append(&ws, _24$$12, PH_SEPARATE, "nc/db/dbabstract.zep", 552);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "gte")) {
				...
				zephir_array_append(&ws, _27$$13, PH_SEPARATE, "nc/db/dbabstract.zep", 555);
				break;
			}
			...
			if (ZEPHIR_IS_STRING(k2, "between")) {
				...
				if (unlikely(_29$$15)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid between", "nc/db/dbabstract.zep", 561);
					return;
				}
				zephir_array_fetch_long(&_31$$15, v, 0, PH_NOISY | PH_READONLY, "nc/db/dbabstract.zep", 563 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_30$$15, this_ptr, "quote", &_32, 0, _31$$15);
				zephir_check_call_status();
				zephir_array_fetch_long(&_34$$15, v, 1, PH_NOISY | PH_READONLY, "nc/db/dbabstract.zep", 563 TSRMLS_CC);
				...
				zephir_array_append(&ws, _36$$15, PH_SEPARATE, "nc/db/dbabstract.zep", 563);
				break;
			}
			...
			if (ZEPHIR_IS_STRING(k2, "like")) {
				...
				zephir_array_append(&ws, _39$$18, PH_SEPARATE, "nc/db/dbabstract.zep", 568);
				break;
			}
			...
			if (ZEPHIR_IS_STRING(k2, "in")) {
				...
				if (unlikely(_40$$20)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid in", "nc/db/dbabstract.zep", 574);
					return;
				}
				...
				if (ZEPHIR_IS_FALSE_IDENTICAL(_42$$20)) {
					...
					ZEPHIR_CALL_FUNCTION(&_46$$22, "array_map", &_47, 6, _44$$22, v);
					zephir_check_call_status();
					zephir_fast_join_str(_43$$22, SL(", "), _46$$22 TSRMLS_CC);
					ZEPHIR_INIT_LNVAR(_48$$22);
					ZEPHIR_CONCAT_VVSVS(_48$$22, k1, tmp, " IN (", _43$$22, ")");
					zephir_array_append(&ws, _48$$22, PH_SEPARATE, "nc/db/dbabstract.zep", 577);
				} else {
					ZEPHIR_CALL_METHOD(&_49$$23, this_ptr, "parsewheremultiplein", &_50, 0, k1, v, tmp);
					zephir_check_call_status();
					zephir_array_append(&ws, _49$$23, PH_SEPARATE, "nc/db/dbabstract.zep", 579);
				}
				break;
			}
			...
			if (ZEPHIR_IS_STRING(k2, "inSelect")) {
				...
				zephir_array_append(&ws, _54$$25, PH_SEPARATE, "nc/db/dbabstract.zep", 588);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "raw")) {
				ZEPHIR_INIT_LNVAR(_55$$27);
				ZEPHIR_CONCAT_SVS(_55$$27, "(", v, ")");
				zephir_array_append(&ws, _55$$27, PH_SEPARATE, "nc/db/dbabstract.zep", 592);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "expression")) {
				...
				if (unlikely(_56$$28)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid expression", "nc/db/dbabstract.zep", 596);
					return;
				}
				...
				zephir_array_fast_append(_60$$28, _59$$28);
				ZEPHIR_MAKE_REF(v);
				ZEPHIR_CALL_FUNCTION(&_61$$28, "array_shift", &_4, 5, v);
				ZEPHIR_UNREF(v);
				zephir_check_call_status();
				...
				if (unlikely(zephir_fast_strlen_ev(tmp) > 0)) {
					...
					ZEPHIR_CALL_FUNCTION(&_67$$30, "array_map", &_47, 6, _65$$30, v);
					zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_68$$30, "vsprintf", &_69, 7, tmp, _67$$30);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_70$$30);
					ZEPHIR_CONCAT_SVS(_70$$30, "(", _68$$30, ")");
					zephir_array_append(&ws, _70$$30, PH_SEPARATE, "nc/db/dbabstract.zep", 601);
				}
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "and")) {
				...
				if (unlikely(_71$$31)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid and", "nc/db/dbabstract.zep", 607);
					return;
				}
				ZEPHIR_INIT_NVAR(_73$$31);
				ZVAL_STRING(_73$$31, " AND ", ZEPHIR_TEMP_PARAM_COPY);
				ZEPHIR_CALL_METHOD(&_72$$31, this_ptr, "parsewhere", &_74, 8, v, _73$$31);
				zephir_check_temp_parameter(_73$$31);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_75$$31);
				ZEPHIR_CONCAT_SVS(_75$$31, "(", _72$$31, ")");
				zephir_array_append(&ws, _75$$31, PH_SEPARATE, "nc/db/dbabstract.zep", 609);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "or")) {
				...
				if (unlikely(_76$$33)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid or", "nc/db/dbabstract.zep", 613);
					return;
				}
				ZEPHIR_INIT_NVAR(_78$$33);
				ZVAL_STRING(_78$$33, " OR ", ZEPHIR_TEMP_PARAM_COPY);
				ZEPHIR_CALL_METHOD(&_77$$33, this_ptr, "parsewhere", &_74, 8, v, _78$$33);
				zephir_check_temp_parameter(_78$$33);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_79$$33);
				ZEPHIR_CONCAT_SVS(_79$$33, "(", _77$$33, ")");
				zephir_array_append(&ws, _79$$33, PH_SEPARATE, "nc/db/dbabstract.zep", 615);
				break;
			}
			if (ZEPHIR_IS_STRING(k2, "xor")) {
				...
				if (unlikely(_80$$35)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_db_exception_ce, "Invalid xor", "nc/db/dbabstract.zep", 619);
					return;
				}
				ZEPHIR_INIT_NVAR(_82$$35);
				ZVAL_STRING(_82$$35, " XOR ", ZEPHIR_TEMP_PARAM_COPY);
				ZEPHIR_CALL_METHOD(&_81$$35, this_ptr, "parsewhere", &_74, 8, v, _82$$35);
				zephir_check_temp_parameter(_82$$35);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_83$$35);
				ZEPHIR_CONCAT_SVS(_83$$35, "(", _81$$35, ")");
				zephir_array_append(&ws, _83$$35, PH_SEPARATE, "nc/db/dbabstract.zep", 621);
				break;
			}
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_84$$37, "nc/db/dbabstract.zep", 625 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);
...
PHP_METHOD(Nc_Db_DbAbstract, parseWhereMultipleIn) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, ",", 0);
	ZEPHIR_CALL_FUNCTION(&_1, "substr_count", NULL, 9, columns, &_0);
	zephir_check_call_status();
	...
	if (unlikely(c < 2)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$3, "nc/db/dbabstract.zep", 639 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_is_iterable(values, &_6, &_5, 0, 0, "nc/db/dbabstract.zep", 651);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_6, &_5)
		...
		if (unlikely(_8$$4)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_9$$5, "nc/db/dbabstract.zep", 646 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		ZEPHIR_INIT_NVAR(_11$$4);
		ZEPHIR_CALL_FUNCTION(&_12$$4, "array_map", &_13, 6, quoter, v);
		zephir_check_call_status();
		zephir_fast_join_str(_11$$4, SL(", "), _12$$4 TSRMLS_CC);
		ZEPHIR_INIT_LNVAR(_14$$4);
		ZEPHIR_CONCAT_SVS(_14$$4, "(", _11$$4, ")");
		zephir_array_append(&vs, _14$$4, PH_SEPARATE, "nc/db/dbabstract.zep", 648);
	}
	ZEPHIR_INIT_NVAR(_4);
...
PHP_METHOD(Nc_Db_DbAbstract, pickWhereByKey) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *data_param = NULL, *key, *k = NULL, *v = NULL, *where = NULL, **_2$$3, *_3$$5 = NULL, *_4$$5 = NULL, *_7$$7, *_8$$7;
	zval *data = NULL;

	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 2, 0, &data_param, &key);
	...
	if (Z_TYPE_P(key) == IS_ARRAY) {
		zephir_is_iterable(key, &_1$$3, &_0$$3, 0, 0, "nc/db/dbabstract.zep", 665);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
			...
			if (unlikely(!(zephir_array_isset_fetch(&v, data, k, 0 TSRMLS_CC)))) {
				...
				ZEPHIR_CONCAT_SV(_4$$5, "Cannot find value in data: ", k);
				ZEPHIR_CALL_METHOD(NULL, _3$$5, "__construct", &_5, 2, _4$$5);
				zephir_check_call_status();
				zephir_throw_exception_debug(_3$$5, "nc/db/dbabstract.zep", 661 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		zephir_get_strval(_6$$6, key);
		ZEPHIR_CPY_WRT(k, _6$$6);
		ZEPHIR_OBS_NVAR(v);
		if (unlikely(!(zephir_array_isset_fetch(&v, data, k, 0 TSRMLS_CC)))) {
			ZEPHIR_INIT_VAR(_7$$7);
			object_init_ex(_7$$7, nc_db_exception_ce);
			ZEPHIR_INIT_VAR(_8$$7);
			ZEPHIR_CONCAT_SV(_8$$7, "Cannot find value in data: ", k);
			ZEPHIR_CALL_METHOD(NULL, _7$$7, "__construct", &_5, 2, _8$$7);
			zephir_check_call_status();
			zephir_throw_exception_debug(_7$$7, "nc/db/dbabstract.zep", 668 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_array_update_zval(&where, k, &v, PH_COPY | PH_SEPARATE);
