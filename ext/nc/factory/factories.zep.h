...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_factory_factories_set, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_factory_factories_newproduction, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()

ZEPHIR_INIT_FUNCS(nc_factory_factories_method_entry) {
	PHP_ME(Nc_Factory_Factories, set, arginfo_nc_factory_factories_set, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Nc_Factory_Factories, newProduction, arginfo_nc_factory_factories_newproduction, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
