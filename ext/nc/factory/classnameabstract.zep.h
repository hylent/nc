...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_factory_classnameabstract___get, 0, 0, 1)
	ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(nc_factory_classnameabstract_method_entry) {
	...
	PHP_ME(Nc_Factory_ClassNameAbstract, __get, arginfo_nc_factory_classnameabstract___get, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Nc_Factory_ClassNameAbstract, getClassName, arginfo_nc_factory_classnameabstract_getclassname, ZEND_ACC_ABSTRACT|ZEND_ACC_PROTECTED)
	PHP_FE_END
};
