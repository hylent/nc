...
PHP_METHOD(Nc_Cache_Memcache, __construct) {
	...
	long port, timeout;
	zval *host_param = NULL, *port_param = NULL, *timeout_param = NULL, *mc = NULL, _0, *_1 = NULL, *_2 = NULL, *_3, *_4;
	zval *host = NULL;
	...
	if (zephir_has_constructor(mc TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(NULL, mc, "__construct", NULL, 0);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(_3);
	ZVAL_LONG(_3, port);
	...
	ZEPHIR_CALL_METHOD(&_2, mc, "connect", NULL, 0, host, _3, _4);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Cache_Memcache, rawSet) {
	...
	ZEPHIR_CALL_METHOD(NULL, _0, "set", NULL, 0, key, value, _1, _2);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Cache_Memcache, getInteger) {
	...
	ZEPHIR_INIT_VAR(_0);
	ZEPHIR_CONCAT_SV(_0, ":i:", key);
	ZEPHIR_CALL_METHOD(&value, this_ptr, "rawget", NULL, 0, _0);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Cache_Memcache, incrementInteger) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	long step;
	zval *key_param = NULL, *step_param = NULL, *value = NULL, *_0, *_2, *_3$$3;
	zval *key = NULL, *_1;
	...
	ZEPHIR_INIT_VAR(_2);
	ZVAL_LONG(_2, step);
	ZEPHIR_CALL_METHOD(&value, _0, "increment", NULL, 0, _1, _2);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(value)) {
		ZEPHIR_INIT_VAR(_3$$3);
		ZVAL_LONG(_3$$3, step);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setinteger", NULL, 0, key, _3$$3);
		zephir_check_call_status();
		RETURN_MM_LONG(step);
	}
	RETURN_MM_LONG(((zephir_get_numberval(value) - 1000000000)));
...
PHP_METHOD(Nc_Cache_Memcache, decrementInteger) {
	...
	ZEPHIR_INIT_VAR(_2);
	ZVAL_LONG(_2, step);
	ZEPHIR_CALL_METHOD(&value, _0, "decrement", NULL, 0, _1, _2);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(value)) {
		ZEPHIR_INIT_VAR(_3$$3);
		ZVAL_LONG(_3$$3, -step);
...
PHP_METHOD(Nc_Cache_Memcache, multiGet) {
	...
	zend_bool _1;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *keys_param = NULL, *a = NULL, *k = NULL, *v = NULL, *data = NULL, *_0, **_4$$3, *_5$$4, *_6$$4 = NULL;
	zval *keys = NULL;
	...
	array_init(data);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("memcache"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&a, _0, "get", NULL, 0, keys);
	zephir_check_call_status();
	...
	if (_1) {
		zephir_is_iterable(a, &_3$$3, &_2$$3, 0, 0, "nc/cache/memcache.zep", 106);
		for (
