...
PHP_METHOD(Nc_Cache_Apc, flush) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "apc_clear_cache", NULL, 15, &_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Cache_Apc, rawSet) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "apc_store", NULL, 16, key, value, &_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Cache_Apc, rawGet) {
	...
	ZEPHIR_CALL_FUNCTION(&r, "apc_fetch", NULL, 17, key);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Cache_Apc, rawDelete) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "apc_delete", NULL, 18, key);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Cache_Apc, incrementInteger) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	long step;
	zval *key_param = NULL, *step_param = NULL, *value = NULL, *_0, _1$$3;
	...
	ZEPHIR_INIT_VAR(_0);
	ZVAL_LONG(_0, step);
	ZEPHIR_CALL_FUNCTION(&value, "apc_inc", NULL, 19, realKey, _0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(value)) {
		ZEPHIR_SINIT_VAR(_1$$3);
		ZVAL_LONG(&_1$$3, step);
		ZEPHIR_CALL_FUNCTION(NULL, "apc_store", NULL, 16, realKey, &_1$$3);
		zephir_check_call_status();
		RETURN_MM_LONG(step);
	}
...
PHP_METHOD(Nc_Cache_Apc, decrementInteger) {
	...
	ZEPHIR_INIT_VAR(_0);
	ZVAL_LONG(_0, step);
	ZEPHIR_CALL_FUNCTION(&value, "apc_dec", NULL, 20, realKey, _0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(value)) {
		ZEPHIR_SINIT_VAR(_1$$3);
		ZVAL_LONG(&_1$$3, -step);
...
PHP_METHOD(Nc_Cache_Apc, multiSet) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	long expiredAt;
	zval *keyValues_param = NULL, *expiredAt_param = NULL, *k = NULL, *v = NULL, *data = NULL, **_2, *_5, _6, *_3$$3, *_4$$3 = NULL;
	zval *keyValues = NULL;
	...
	zephir_time(_5);
	ZEPHIR_SINIT_VAR(_6);
	ZVAL_LONG(&_6, (expiredAt - zephir_get_numberval(_5)));
	ZEPHIR_CALL_FUNCTION(NULL, "apc_store", NULL, 16, data, &_6);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Cache_Apc, multiGet) {
	...
	zend_bool _0;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *keys_param = NULL, *r = NULL, *k = NULL, *v = NULL, *data = NULL, **_3$$3, *_4$$4, *_5$$4 = NULL;
	zval *keys = NULL;
	...
	ZEPHIR_INIT_VAR(data);
	array_init(data);
	ZEPHIR_CALL_FUNCTION(&r, "apc_fetch", NULL, 17, keys);
	zephir_check_call_status();
	...
	if (_0) {
		zephir_is_iterable(r, &_2$$3, &_1$$3, 0, 0, "nc/cache/apc.zep", 93);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_2$$3, &_1$$3)
			...
			_4$$4 = zephir_fetch_nproperty_this(this_ptr, SL("serializer"), PH_NOISY_CC);
			ZEPHIR_CALL_METHOD(&_5$$4, _4$$4, "unserialize", NULL, 0, v);
			zephir_check_call_status();
			zephir_array_update_zval(&data, k, &_5$$4, PH_COPY | PH_SEPARATE);
		}
	}
	RETURN_CCTOR(data);
