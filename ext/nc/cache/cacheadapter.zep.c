...
ZEPHIR_INIT_CLASS(Nc_Cache_CacheAdapter) {
	...
	ZEPHIR_REGISTER_CLASS(Nc\\Cache, CacheAdapter, nc, cache_cacheadapter, nc_cache_cacheadapter_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_declare_property_null(nc_cache_cacheadapter_ce, SL("serializer"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(nc_cache_cacheadapter_ce TSRMLS_CC, 1, nc_cache_cacheinterface_ce);
	zend_class_implements(nc_cache_cacheadapter_ce TSRMLS_CC, 1, nc_serializer_serializerawareinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Nc_Cache_CacheAdapter, multiSet) {
	...
	zephir_is_iterable(keyValues, &_1, &_0, 0, 0, "nc/cache/cacheadapter.zep", 86);
	for (
...
PHP_METHOD(Nc_Cache_CacheAdapter, multiGet) {
	...
	zephir_is_iterable(keys, &_1, &_0, 0, 0, "nc/cache/cacheadapter.zep", 99);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
...
PHP_METHOD(Nc_Cache_CacheAdapter, multiDelete) {
	...
	zephir_is_iterable(keys, &_1, &_0, 0, 0, "nc/cache/cacheadapter.zep", 109);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupSetAll) {
	...
	zephir_is_iterable(keyValues, &_1, &_0, 0, 0, "nc/cache/cacheadapter.zep", 124);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupGetAll) {
	...
	zephir_is_iterable(_1, &_3, &_2, 0, 0, "nc/cache/cacheadapter.zep", 148);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		zephir_array_append(&ks, _5, PH_SEPARATE, "nc/cache/cacheadapter.zep", 145);
	}
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "multiget", NULL, ks);
	zephir_check_call_status();
	zephir_is_iterable(_6, &_8, &_7, 0, 0, "nc/cache/cacheadapter.zep", 154);
	for (
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupDeleteAll) {
	...
	ZEPHIR_INIT_VAR(_1);
	zephir_array_keys(_1, groupedKeys TSRMLS_CC);
	zephir_is_iterable(_1, &_3, &_2, 0, 0, "nc/cache/cacheadapter.zep", 175);
	for (
	  ; zephir_hash_get_current_data_ex(_3, (void**) &_4, &_2) == SUCCESS
	  ; zephir_hash_move_forward_ex(_3, &_2)
	) {
		...
		ZEPHIR_INIT_LNVAR(_5);
		ZEPHIR_CONCAT_VV(_5, prefix, k);
		zephir_array_append(&ks, _5, PH_SEPARATE, "nc/cache/cacheadapter.zep", 172);
	}
	zephir_array_append(&ks, realGroup, PH_SEPARATE, "nc/cache/cacheadapter.zep", 175);
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupSet) {
	...
	ZEPHIR_INIT_VAR(prefix);
	ZEPHIR_CONCAT_VS(prefix, realGroup, ":");
	zephir_is_iterable(keyValues, &_1, &_0, 0, 0, "nc/cache/cacheadapter.zep", 198);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupGet) {
	...
	zephir_check_call_status();
	zephir_is_iterable(_1, &_4, &_3, 0, 0, "nc/cache/cacheadapter.zep", 224);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_4, &_3)
		...
		if (zephir_array_key_exists(groupedKeys, k TSRMLS_CC)) {
			...
			zephir_array_append(&ks, _6, PH_SEPARATE, "nc/cache/cacheadapter.zep", 220);
		}
	}
	...
	zephir_check_call_status();
	zephir_is_iterable(_7, &_9, &_8, 0, 0, "nc/cache/cacheadapter.zep", 234);
	for (
...
PHP_METHOD(Nc_Cache_CacheAdapter, groupDelete) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "array_unique", &_2, keys);
	zephir_check_call_status();
	zephir_is_iterable(_1, &_4, &_3, 0, 0, "nc/cache/cacheadapter.zep", 258);
	for (
	  ; zephir_hash_get_current_data_ex(_4, (void**) &_5, &_3) == SUCCESS
	  ; zephir_hash_move_forward_ex(_4, &_3)
	) {
		...
		if (zephir_array_key_exists(groupedKeys, k TSRMLS_CC)) {
			...
			ZEPHIR_INIT_LNVAR(_6);
			ZEPHIR_CONCAT_VV(_6, prefix, k);
			zephir_array_append(&ks, _6, PH_SEPARATE, "nc/cache/cacheadapter.zep", 254);
		}
	}
	if (zephir_is_true(ks)) {
