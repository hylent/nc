...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_storage_ftp_ignoreerror, 0, 0, 4)
	ZEND_ARG_INFO(0, n)
	ZEND_ARG_INFO(0, s)
	ZEND_ARG_INFO(0, f)
	ZEND_ARG_INFO(0, l)
...
ZEPHIR_INIT_FUNCS(nc_storage_ftp_method_entry) {
	PHP_ME(Nc_Storage_Ftp, ignoreError, arginfo_nc_storage_ftp_ignoreerror, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(Nc_Storage_Ftp, getBaseDirectory, NULL, ZEND_ACC_PUBLIC)
