...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_mvc_contexthttpswoole_startsession, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(nc_mvc_contexthttpswoole_method_entry) {
	...
	PHP_ME(Nc_Mvc_ContextHttpSwoole, startSession, arginfo_nc_mvc_contexthttpswoole_startsession, ZEND_ACC_PUBLIC)
