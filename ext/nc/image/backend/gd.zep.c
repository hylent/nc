...
ZEPHIR_INIT_CLASS(Nc_Image_Backend_Gd) {

	ZEPHIR_REGISTER_CLASS_EX(Nc\\Image\\Backend, Gd, nc, image_backend_gd, nc_image_backend_imagebackendadapter_ce, nc_image_backend_gd_method_entry, 0);

	return SUCCESS;

}

PHP_METHOD(Nc_Image_Backend_Gd, __construct) {
	...
	if (unlikely(!zephir_is_true(_1))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Missing extension: gd", "nc/image/backend/gd.zep", 12);
		return;
	}
...
PHP_METHOD(Nc_Image_Backend_Gd, text) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, imProperties, SL("fontSize"), PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 27 TSRMLS_CC);
	zephir_array_fetch_string(&_1, imProperties, SL("font"), PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 27 TSRMLS_CC);
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_LONG(&_2, 0);
	ZEPHIR_CALL_FUNCTION(&box, "imagettfbbox", NULL, _0, &_2, _1, text);
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(box))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "imagettfbbox", "nc/image/backend/gd.zep", 29);
		return;
	}
	ZEPHIR_OBS_VAR(_3);
	zephir_array_fetch_string(&_3, imProperties, SL("padding"), PH_NOISY, "nc/image/backend/gd.zep", 32 TSRMLS_CC);
	padding2 = (2 * zephir_get_intval(_3));
	zephir_array_update_string(&imProperties, SL("text"), &text, PH_COPY | PH_SEPARATE);
	zephir_array_fetch_long(&_4, box, 2, PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 35 TSRMLS_CC);
	zephir_array_fetch_long(&_5, box, 6, PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 35 TSRMLS_CC);
	...
	zephir_array_fetch_long(&_4, box, 3, PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 36 TSRMLS_CC);
	zephir_array_fetch_long(&_5, box, 7, PH_NOISY | PH_READONLY, "nc/image/backend/gd.zep", 36 TSRMLS_CC);
	ZEPHIR_SINIT_VAR(_7);
...
PHP_METHOD(Nc_Image_Backend_Gd, captcha) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_0);
	zephir_array_fetch_string(&_0, validOptions, SL("font"), PH_NOISY, "nc/image/backend/gd.zep", 50 TSRMLS_CC);
	zephir_get_strval(_1, _0);
	ZEPHIR_CPY_WRT(font, _1);
	ZEPHIR_OBS_VAR(_2);
	zephir_array_fetch_string(&_2, validOptions, SL("rPadding"), PH_NOISY, "nc/image/backend/gd.zep", 51 TSRMLS_CC);
	rPadding = zephir_get_doubleval(_2);
	ZEPHIR_OBS_VAR(_3);
	zephir_array_fetch_string(&_3, validOptions, SL("rOverlap"), PH_NOISY, "nc/image/backend/gd.zep", 52 TSRMLS_CC);
...
PHP_METHOD(Nc_Image_Backend_Gd, fromImage) {
...
PHP_METHOD(Nc_Image_Backend_Gd, fromSize) {
	...
	if (width < 1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Argument width must be positive", "nc/image/backend/gd.zep", 137);
		return;
	}
	if (height < 1) {
		height = width;
	...
	if (unlikely(!zephir_is_true(handler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Cannot create image", "nc/image/backend/gd.zep", 146);
		return;
	}
...
PHP_METHOD(Nc_Image_Backend_Gd, fromPath) {
	...
	do {
		...
		ZEPHIR_INIT_NVAR(_0);
		object_init_ex(_0, nc_image_backend_exception_ce);
		ZEPHIR_INIT_VAR(_5);
		ZEPHIR_CONCAT_SV(_5, "Unsupported extension: ", ext);
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, _5);
		zephir_check_call_status();
		zephir_throw_exception_debug(_0, "nc/image/backend/gd.zep", 187 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);

	if (unlikely(!zephir_is_true(handler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Cannot create image", "nc/image/backend/gd.zep", 191);
		return;
	}
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
...
PHP_METHOD(Nc_Image_Backend_Gd, fromString) {
	...
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(handler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Cannot create image", "nc/image/backend/gd.zep", 218);
		return;
	}
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, handler, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
...
PHP_METHOD(Nc_Image_Backend_Gd, resize) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Argument width must be positive", "nc/image/backend/gd.zep", 238);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Nc_Image_Backend_Gd, crop) {
	...
	if (unlikely(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Arguments x and y must not be negative", "nc/image/backend/gd.zep", 270);
		return;
	}
	if (unlikely(w < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Argument w must be positive", "nc/image/backend/gd.zep", 274);
		return;
	}
	if (h < 1) {
		h = w;
	...
	if (unlikely(_3)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Cropping out of area", "nc/image/backend/gd.zep", 282);
		return;
	}
	ZEPHIR_INIT_VAR(_6);
	ZEPHIR_INIT_NVAR(_6);
...
PHP_METHOD(Nc_Image_Backend_Gd, thumbnail) {
	...
	if (unlikely(width < 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Width must be positive", "nc/image/backend/gd.zep", 297);
		return;
	}
	if (height < 1) {
		height = width;
...
PHP_METHOD(Nc_Image_Backend_Gd, draw) {
	...
	do {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_0, "nc/image/backend/gd.zep", 353 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while (0);
...
PHP_METHOD(Nc_Image_Backend_Gd, save) {
	...
	do {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Unsupported extension", "nc/image/backend/gd.zep", 382);
		return;
	} while(0);

	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "Cannot save image", "nc/image/backend/gd.zep", 385);
	return;

}

PHP_METHOD(Nc_Image_Backend_Gd, destroy) {
...
PHP_METHOD(Nc_Image_Backend_Gd, drawText) {
	...
	if (!(zephir_instance_of_ev(dest, nc_image_image_ce TSRMLS_CC))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Parameter 'dest' must be an instance of 'Nc\\Image\\Image'", "", 0);
		return;
	}
	if (!(zephir_instance_of_ev(src, nc_image_text_ce TSRMLS_CC))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Parameter 'src' must be an instance of 'Nc\\Image\\Text'", "", 0);
		return;
	}
	ZEPHIR_INIT_VAR(_0);
	ZEPHIR_INIT_NVAR(_0);
	...
	if (unlikely(!zephir_is_true(_23))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "imagettftext", "nc/image/backend/gd.zep", 409);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Image_Backend_Gd, copy) {
	...
	if (!(zephir_instance_of_ev(src, nc_image_image_ce TSRMLS_CC))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Parameter 'src' must be an instance of 'Nc\\Image\\Image'", "", 0);
		return;
	}
	ZEPHIR_INIT_VAR(_0);
	ZEPHIR_INIT_NVAR(_0);
	...
	if (unlikely(!zephir_is_true(_12))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "imagecopy", "nc/image/backend/gd.zep", 416);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Image_Backend_Gd, copyResampled) {
	...
	zephir_check_call_status();
	if (unlikely(!zephir_is_true(_12))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(nc_image_backend_exception_ce, "imagecopyresampled", "nc/image/backend/gd.zep", 425);
		return;
	}
	ZEPHIR_MM_RESTORE();
