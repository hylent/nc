...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_image_gd_largest, 0, 0, 3)
	ZEND_ARG_OBJ_INFO(0, im, Nc\\Image\\Image, 0)
	ZEND_ARG_INFO(0, width)
	ZEND_ARG_INFO(0, height)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_nc_image_gd_creategdimagefromsize, 0, 0, 2)
	ZEND_ARG_INFO(0, width)
	ZEND_ARG_INFO(0, height)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(nc_image_gd_method_entry) {
	...
	PHP_ME(Nc_Image_Gd, createGdImageFromSize, arginfo_nc_image_gd_creategdimagefromsize, ZEND_ACC_PROTECTED)
