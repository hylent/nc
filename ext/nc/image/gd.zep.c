...
PHP_METHOD(Nc_Image_Gd, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, nc_image_gd_ce, this_ptr, "__construct", &_2, 54, defaultOptions);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Image_Gd, fromPath) {
	...
	if (!(!extension) && Z_STRLEN_P(extension)) {
		...
		ZVAL_LONG(&_2$$4, 4);
		ZEPHIR_CALL_FUNCTION(&_3$$4, "pathinfo", NULL, 33, path, &_2$$4);
		zephir_check_call_status();
...
PHP_METHOD(Nc_Image_Gd, save) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *destPath = NULL;
	zval *im, *destPath_param = NULL, *_0, *_1$$3, *_2$$3 = NULL, *_3$$3 = NULL, *_4$$3 = NULL, *_5$$5, *_6$$5 = NULL, *_7$$5 = NULL, *_8$$5 = NULL, *_9$$7, *_10$$7 = NULL, *_11$$7 = NULL, _12$$7, *_13$$7 = NULL, *_14$$9, *_15$$9, *_16$$9;
	...
	do {
		if (ZEPHIR_IS_STRING(_0, "png")) {
			...
			ZEPHIR_CALL_FUNCTION(&_4$$3, "imagepng", NULL, 69, _1$$3, _2$$3);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "gif")) {
			ZEPHIR_OBS_VAR(_5$$5);
			zephir_read_property(&_5$$5, im, SL("handler"), PH_NOISY_CC);
			ZEPHIR_INIT_VAR(_6$$5);
			if (zephir_fast_strlen_ev(destPath) > 0) {
				ZEPHIR_CPY_WRT(_6$$5, destPath);
			} else {
				ZEPHIR_INIT_NVAR(_6$$5);
				ZVAL_NULL(_6$$5);
			}
			ZEPHIR_CALL_FUNCTION(&_8$$5, "imagegif", NULL, 70, _5$$5, _6$$5);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(_0, "jpg") || ZEPHIR_IS_STRING(_0, "jpeg")) {
			ZEPHIR_OBS_VAR(_9$$7);
			zephir_read_property(&_9$$7, im, SL("handler"), PH_NOISY_CC);
			ZEPHIR_INIT_VAR(_10$$7);
			if (zephir_fast_strlen_ev(destPath) > 0) {
				ZEPHIR_CPY_WRT(_10$$7, destPath);
			} else {
			...
			ZVAL_LONG(&_12$$7, 100);
			ZEPHIR_CALL_FUNCTION(&_13$$7, "imagejpeg", NULL, 71, _9$$7, _10$$7, &_12$$7);
			zephir_check_call_status();
		...
		object_init_ex(_14$$9, nc_image_exception_ce);
		ZEPHIR_OBS_VAR(_15$$9);
		zephir_read_property(&_15$$9, im, SL("extension"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(_16$$9);
		ZEPHIR_CONCAT_SV(_16$$9, "Unsupported extension: ", _15$$9);
		ZEPHIR_CALL_METHOD(NULL, _14$$9, "__construct", NULL, 2, _16$$9);
		zephir_check_call_status();
		zephir_throw_exception_debug(_14$$9, "nc/image/gd.zep", 394 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
