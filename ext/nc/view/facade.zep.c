...
PHP_METHOD(Nc_View_Facade, __invoke) {
	...
	while (1) {
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(_3$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, _4$$6, "__construct", &_6, 132, _5$$6);
			zephir_check_temp_parameter(_5$$6);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_7$$6, _4$$6, "__get", &_8, 133, view);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, _9$$3, "__construct", &_6, 132, _10$$3);
		zephir_check_temp_parameter(_10$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_11$$3, _9$$3, "__get", &_8, 133, view);
		zephir_check_call_status();
