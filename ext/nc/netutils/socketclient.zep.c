...
PHP_METHOD(Nc_NetUtils_SocketClient, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&handler, "stream_socket_client", NULL, 95, address, errNo, errStr, _4, _5);
	ZEPHIR_UNREF(errNo);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, setTcpNodelay) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("handler"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&socket, "socket_import_stream", NULL, 96, _0);
	zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&_4, "socket_set_option", NULL, 97, socket, &_2, &_3, _1);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, setBlocking) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "stream_set_blocking", NULL, 98, _0, _1);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, setTimeout) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "stream_set_timeout", NULL, 99, _0, &_1, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, enableCrypto) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("handler"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&_1, "stream_socket_enable_crypto", NULL, 100, _0, ZEPHIR_GLOBAL(global_true), cryptoType);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, readLine) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("handler"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&line, "fgets", NULL, 101, _0);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SocketClient, readAll) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("handler"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&line, "stream_get_contents", NULL, 102, _0);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(line))) {
...
PHP_METHOD(Nc_NetUtils_SocketClient, readLength) {
	...
	ZEPHIR_SINIT_VAR(_5);
	ZVAL_LONG(&_5, len);
	ZEPHIR_CALL_FUNCTION(&line, "stream_get_contents", NULL, 102, _4, &_5);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(line))) {
...
PHP_METHOD(Nc_NetUtils_SocketClient, readMaxLength) {
	...
	ZEPHIR_SINIT_VAR(_5);
	ZVAL_LONG(&_5, len);
	ZEPHIR_CALL_FUNCTION(&line, "fread", NULL, 103, _4, &_5);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(line))) {
