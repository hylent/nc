...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&handler, "stream_socket_client", NULL, 118, &address, &errNo, &errStr, &_7, &flags);
	ZEPHIR_UNREF(&errNo);
	ZEPHIR_UNREF(&errStr);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, setTcpNodelay) {
	...
	zephir_read_property(&_0, this_ptr, SL("handler"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&socket, "socket_import_stream", NULL, 119, &_0);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 6);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&_4, "socket_set_option", NULL, 120, &socket, &_2, &_3, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, setBlocking) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "stream_set_blocking", NULL, 121, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, setTimeout) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "stream_set_timeout", NULL, 122, &_0, &_1, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, enableCrypto) {
	...
	zephir_read_property(&_0, this_ptr, SL("handler"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&_1, "stream_socket_enable_crypto", NULL, 123, &_0, &__$true, cryptoType);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, readLine) {
	...
	zephir_read_property(&_0, this_ptr, SL("handler"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&line, "fgets", NULL, 124, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, readAll) {
	...
	zephir_read_property(&_0, this_ptr, SL("handler"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&line, "stream_get_contents", NULL, 125, &_0);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(&line))) {
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, readLength) {
	...
	ZVAL_LONG(&_5, len);
	ZEPHIR_CALL_FUNCTION(&line, "stream_get_contents", NULL, 125, &_4, &_5);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(&line))) {
...
PHP_METHOD(Nc_NetUtils_TcpSocketClient, readMaxLength) {
	...
	zephir_read_property(&_4, this_ptr, SL("handler"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_5, len);
	ZEPHIR_CALL_FUNCTION(&line, "fread", NULL, 126, &_4, &_5);
	zephir_check_call_status();
	if (unlikely(ZEPHIR_IS_FALSE_IDENTICAL(&line))) {
