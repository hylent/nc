...
PHP_METHOD(Nc_NetUtils_SmtpMailer, __construct) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, nc_std_ce, "valueat", &_1, 4, options, _2);
	...
	ZEPHIR_CALL_CE_STATIC(&_4, nc_std_ce, "valueat", &_1, 4, options, _2);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_6, nc_std_ce, "valueat", &_1, 4, options, _2);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_8, nc_std_ce, "valueat", &_1, 4, options, _2, user);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_10, nc_std_ce, "valueat", &_1, 4, options, _2, _11);
	zephir_check_temp_parameter(_2);
	...
	ZVAL_LONG(_11, 10);
	ZEPHIR_CALL_CE_STATIC(&_13, nc_std_ce, "valueat", &_1, 4, options, _2, _11);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_11);
	ZVAL_LONG(_11, 5);
	ZEPHIR_CALL_CE_STATIC(&_14, nc_std_ce, "valueat", &_1, 4, options, _2, _11);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_11);
	ZVAL_BOOL(_11, 0);
	ZEPHIR_CALL_CE_STATIC(&_15, nc_std_ce, "valueat", &_1, 4, options, _2, _11);
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	...
	if (secure) {
		...
		ZVAL_LONG(_18$$3, 465);
		ZEPHIR_CALL_CE_STATIC(&_16$$3, nc_std_ce, "valueat", &_1, 4, options, _17$$3, _18$$3);
		...
		ZVAL_LONG(_21$$4, 25);
		ZEPHIR_CALL_CE_STATIC(&_19$$4, nc_std_ce, "valueat", &_1, 4, options, _20$$4, _21$$4);
	...
	ZEPHIR_INIT_VAR(_22);
	ZVAL_BOOL(_22, 0);
	ZEPHIR_CALL_METHOD(NULL, socket, "__construct", NULL, 84, host, _2, _11, _22);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
	ZVAL_BOOL(_2, 1);
	ZEPHIR_CALL_METHOD(NULL, socket, "settcpnodelay", NULL, 85, _2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
	ZVAL_BOOL(_2, 1);
	ZEPHIR_CALL_METHOD(NULL, socket, "setblocking", NULL, 86, _2);
	zephir_check_call_status();
	if (timeout > 0) {
		ZEPHIR_INIT_VAR(_23$$5);
		ZVAL_DOUBLE(_23$$5, timeout);
		ZEPHIR_CALL_METHOD(NULL, socket, "settimeout", NULL, 87, _23$$5);
		zephir_check_call_status();
	}
	if (secure) {
		ZEPHIR_SINIT_VAR(_24$$6);
		ZVAL_STRING(&_24$$6, "STREAM_CRYPTO_METHOD_SSLv23_CLIENT", 0);
		ZEPHIR_CALL_FUNCTION(&_25$$6, "constant", NULL, 88, &_24$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, socket, "enablecrypto", NULL, 89, _25$$6);
		zephir_check_call_status();
	}
	...
	zephir_check_temp_parameter(_11);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_27, "base64_encode", &_28, 90, user);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
	...
	zephir_check_temp_parameter(_2);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_29, "base64_encode", &_28, 90, passwd);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
...
PHP_METHOD(Nc_NetUtils_SmtpMailer, sendMessageTo) {
	...
	ZEPHIR_CALL_CE_STATIC(&_34, nc_std_ce, "uuid", &_35, 16);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_36);
	...
	ZVAL_STRING(&_40, "r", 0);
	ZEPHIR_CALL_FUNCTION(&_41, "gmdate", NULL, 91, &_40);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_42);
	...
	ZEPHIR_CALL_FUNCTION(&_48, "base64_encode", &_49, 90, body);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_50, "chunk_split", &_51, 92, _48);
	zephir_check_call_status();
	...
	if (_53) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_55$$14, &_54$$14)
			...
			ZEPHIR_CALL_FUNCTION(&_64$$15, "base64_encode", &_49, 90, _63$$15);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&_65$$15, "chunk_split", &_51, 92, _64$$15);
			zephir_check_call_status();
...
PHP_METHOD(Nc_NetUtils_SmtpMailer, pack) {
	...
	if (!(!name) && Z_STRLEN_P(name)) {
		ZEPHIR_CALL_FUNCTION(&_0$$3, "base64_encode", NULL, 90, name);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_1$$3);
