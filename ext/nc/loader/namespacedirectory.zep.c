...
PHP_METHOD(Nc_Loader_NamespaceDirectory, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, nc_loader_namespacedirectory_ce, this_ptr, "__construct", &_0, 76, _1);
...
PHP_METHOD(Nc_Loader_NamespaceDirectory, __invoke) {
	...
	ZEPHIR_CALL_CE_STATIC(&_12, nc_loader_loaderabstract_ce, "isloaded", &_13, 77, name);
	zephir_check_call_status();
