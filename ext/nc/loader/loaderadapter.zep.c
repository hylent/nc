...
ZEPHIR_INIT_CLASS(Nc_Loader_LoaderAdapter) {
	...
	ZEPHIR_REGISTER_CLASS(Nc\\Loader, LoaderAdapter, nc, loader_loaderadapter, nc_loader_loaderadapter_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	zend_class_implements(nc_loader_loaderadapter_ce TSRMLS_CC, 1, nc_loader_loaderinterface_ce);
	return SUCCESS;
