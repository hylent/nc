...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, serializeValue) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 119, value);
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, unserializeValue) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("unserialize", NULL, 120, value);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, setGrouped) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, nc_std_groupedredishashserialized_ce, this_ptr, "setgrouped", &_0, 121, identifier, key, _1);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, getGrouped) {
	...
	ZEPHIR_CALL_PARENT(&value, nc_std_groupedredishashserialized_ce, this_ptr, "getgrouped", &_0, 122, identifier, key);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, setManyGrouped) {
	...
	ZEPHIR_CALL_PARENT(NULL, nc_std_groupedredishashserialized_ce, this_ptr, "setmanygrouped", &_5, 123, identifier, data);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, getManyGrouped) {
	...
	ZEPHIR_INIT_VAR(data);
	array_init(data);
	ZEPHIR_CALL_PARENT(&a, nc_std_groupedredishashserialized_ce, this_ptr, "getmanygrouped", &_0, 124, identifier, keys);
	zephir_check_call_status();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, setAllGrouped) {
	...
	ZEPHIR_CALL_PARENT(NULL, nc_std_groupedredishashserialized_ce, this_ptr, "setallgrouped", &_5, 125, identifier, data);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Nc_Std_GroupedRedisHashSerialized, getAllGrouped) {
	...
	ZEPHIR_INIT_VAR(data);
	array_init(data);
	ZEPHIR_CALL_PARENT(&a, nc_std_groupedredishashserialized_ce, this_ptr, "getallgrouped", &_0, 126, identifier);
	zephir_check_call_status();
