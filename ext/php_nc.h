...
#define PHP_NC_VERSION     "1.0.151212"
#define PHP_NC_EXTNAME     "nc"
#define PHP_NC_AUTHOR      "Hylent"
#define PHP_NC_ZEPVERSION  "0.9.1a-dev"
...
#ifdef ZTS
	#define ZEPHIR_GLOBAL(v) TSRMG(nc_globals_id, zend_nc_globals *, v)
#else
	#define ZEPHIR_GLOBAL(v) (nc_globals.v)
#endif

#ifdef ZTS
	#define ZEPHIR_VGLOBAL ((zend_nc_globals *) (*((void ***) tsrm_ls))[TSRM_UNSHUFFLE_RSRC_ID(nc_globals_id)])
#else
