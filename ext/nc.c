...
zend_class_entry *nc_std_ratelimiterbackendinterface_ce;
...
zend_class_entry *nc_std_stdabstract_ce;
...
zend_class_entry *nc_std_backendredis_ce;
zend_class_entry *nc_std_ce;
zend_class_entry *nc_std_exception_ce;
zend_class_entry *nc_std_ratelimiter_ce;
...
static PHP_MINIT_FUNCTION(nc)
{
	...
	ZEPHIR_INIT(Nc_Std_RateLimiterBackendInterface);
	...
	ZEPHIR_INIT(Nc_Std_StdAbstract);
	...
	ZEPHIR_INIT(Nc_Std);
	ZEPHIR_INIT(Nc_Std_BackendRedis);
	ZEPHIR_INIT(Nc_Std_Exception);
	ZEPHIR_INIT(Nc_Std_RateLimiter);
