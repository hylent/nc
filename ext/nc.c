...
zend_class_entry *nc_factory_callback_ce;
...
zend_class_entry *nc_loader_cached_ce;
zend_class_entry *nc_loader_exception_ce;
zend_class_entry *nc_loader_loaders_ce;
...
static PHP_MINIT_FUNCTION(nc)
{
	...
	ZEPHIR_INIT(Nc_Factory_Callback);
	...
	ZEPHIR_INIT(Nc_Loader_Cached);
	ZEPHIR_INIT(Nc_Loader_Exception);
	ZEPHIR_INIT(Nc_Loader_Loaders);
