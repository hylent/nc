...
zend_class_entry *nc_router_sourceinterface_ce;
...
zend_class_entry *nc_data_groupedbackendinterface_ce;
zend_class_entry *nc_data_pivotbackendinterface_ce;
zend_class_entry *nc_data_ratelimiterbackendinterface_ce;
zend_class_entry *nc_data_sequencebackendinterface_ce;
zend_class_entry *nc_data_singlevaluebackendinterface_ce;
zend_class_entry *nc_task_taskexecutorinterface_ce;
zend_class_entry *nc_exception_ce;
zend_class_entry *nc_data_dataabstract_ce;
...
zend_class_entry *nc_router_sourceuri_ce;
...
zend_class_entry *nc_data_exception_ce;
zend_class_entry *nc_data_grouped_ce;
zend_class_entry *nc_data_pivot_ce;
zend_class_entry *nc_data_ratelimiter_ce;
zend_class_entry *nc_data_sequence_ce;
zend_class_entry *nc_data_singlevalue_ce;
...
zend_class_entry *nc_factory_generated_ce;
...
zend_class_entry *nc_logger_logclosure_ce;
...
zend_class_entry *nc_router_sourceargv_ce;
zend_class_entry *nc_router_sourcerequesturi_ce;
zend_class_entry *nc_router_sourcesapistrategy_ce;
zend_class_entry *nc_router_sourceuripatterns_ce;
...
static PHP_MINIT_FUNCTION(nc)
{
	...
	ZEPHIR_INIT(Nc_Router_SourceInterface);
	ZEPHIR_INIT(Nc_View_ViewInterface);
	ZEPHIR_INIT(Nc_Factory_FactoryInterface);
	ZEPHIR_INIT(Nc_Logger_LoggerInterface);
	ZEPHIR_INIT(Nc_Data_GroupedBackendInterface);
	ZEPHIR_INIT(Nc_Data_PivotBackendInterface);
	ZEPHIR_INIT(Nc_Data_RateLimiterBackendInterface);
	ZEPHIR_INIT(Nc_Data_SequenceBackendInterface);
	ZEPHIR_INIT(Nc_Data_SingleValueBackendInterface);
	ZEPHIR_INIT(Nc_Task_TaskExecutorInterface);
	ZEPHIR_INIT(Nc_Exception);
	ZEPHIR_INIT(Nc_Data_DataAbstract);
	...
	ZEPHIR_INIT(Nc_Router_SourceUri);
	...
	ZEPHIR_INIT(Nc_Data_Exception);
	ZEPHIR_INIT(Nc_Data_Grouped);
	ZEPHIR_INIT(Nc_Data_Pivot);
	ZEPHIR_INIT(Nc_Data_RateLimiter);
	ZEPHIR_INIT(Nc_Data_Sequence);
	ZEPHIR_INIT(Nc_Data_SingleValue);
	...
	ZEPHIR_INIT(Nc_Factory_Generated);
	...
	ZEPHIR_INIT(Nc_Logger_LogClosure);
	...
	ZEPHIR_INIT(Nc_Router_SourceArgv);
	ZEPHIR_INIT(Nc_Router_SourceRequestUri);
	ZEPHIR_INIT(Nc_Router_SourceSapiStrategy);
	ZEPHIR_INIT(Nc_Router_SourceUriPatterns);
	ZEPHIR_INIT(Nc_Std);
