...
zend_class_entry *nc_log_loginterface_ce;
zend_class_entry *nc_messager_messagerinterface_ce;
...
zend_class_entry *nc_log_logawareinterface_ce;
zend_class_entry *nc_messager_messagerawareinterface_ce;
...
zend_class_entry *nc_filter_exception_ce;
zend_class_entry *nc_filter_ipregion_ce;
zend_class_entry *nc_filter_uploader_ce;
...
zend_class_entry *nc_messager_exception_ce;
zend_class_entry *nc_messager_smtp_ce;
...
static PHP_MINIT_FUNCTION(nc)
{
	...
	ZEPHIR_INIT(Nc_Log_LogInterface);
	ZEPHIR_INIT(Nc_Messager_MessagerInterface);
	ZEPHIR_INIT(Nc_Storage_StorageAwareInterface);
	ZEPHIR_INIT(Nc_Cache_CacheAwareInterface);
	ZEPHIR_INIT(Nc_Db_DbAwareInterface);
	ZEPHIR_INIT(Nc_Log_LogAwareInterface);
	ZEPHIR_INIT(Nc_Messager_MessagerAwareInterface);
	...
	ZEPHIR_INIT(Nc_Filter_Exception);
	ZEPHIR_INIT(Nc_Filter_IpRegion);
	ZEPHIR_INIT(Nc_Filter_Uploader);
	...
	ZEPHIR_INIT(Nc_Messager_Exception);
	ZEPHIR_INIT(Nc_Messager_Smtp);
